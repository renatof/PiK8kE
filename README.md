...
1) You must change the password for the ubuntu user from the default PiK8kE to a _secure password_ that you can use to log in to your device

2) You need to add any ssh authorized keys you'd like to include to authenticate to the ubuntu user
